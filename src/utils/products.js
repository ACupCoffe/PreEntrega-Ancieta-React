const productos = [
  //placas de video
  {
    ...
    imageProduct: {
      firtsImage:
        "https://http2.mlstatic.com/D_NQ_NP_962916-MLA53856233695_022023-O.webp",
      secondImage:
...

  {
    ...
    description:
      "La última versión de la icónica serie GAMING de MSI ofrece una vez más el rendimiento, la eficiencia con bajo nivel de ruido y la estética que los jugadores incondicionales reconocen y confían. Ahora usted también puede disfrutar de todos sus juegos favoritos con una potente tarjeta gráfica que se mantiene fría y silenciosa. Justo como te gusta.",
    stock: 7,
    type: "placa de video",
    imageProduct: {
      firtsImage:
        "https://http2.mlstatic.com/D_NQ_NP_696491-MLA51231228608_082022-O.webp",
      secondImage:
...

  {
    ...
    imageProduct: {
      firtsImage:
        "https://http2.mlstatic.com/D_NQ_NP_769638-MLA48655460859_122021-O.webp",
      secondImage:
...

  {
    ...
    imageProduct: {
      firtsImage:
        "https://http2.mlstatic.com/D_NQ_NP_916596-MLA42417117578_062020-O.webp",
      secondImage:
  ...
  //mother
  {
    ...
    imageProduct: {
      firtsImage:
        "https://http2.mlstatic.com/D_NQ_NP_906998-MLA44918635571_022021-O.webp",
      secondImage:
...

  {
    ...
    description:
      "Placa base AMD B550 AORUS con diseño digital de energía doble de 12 + 2 fases, disipadores de calor de superficie agrandados, PCIe dual 4.0 / 3.0 x4 M.2 con protectores térmicos duales, Intel® WiFi 6802.11ax, LAN de 2.5GbE, USB frontal Type-C ™, RGB FUSION 2.0, Q-Flash Plus",
    stock: 1,
    type: "placa madre",
    imageProduct: {
      firtsImage:
        "https://http2.mlstatic.com/D_NQ_NP_845563-MLA47726218462_102021-O.webp",
      secondImage:
        "https://http2.mlstatic.com/D_NQ_NP_943983-MLA51290640430_082022-O.webp",
    },
    price: 250,
  },
  ...
  //fuentes
  {
    ...
    imageProduct: {
      firtsImage:
        "https://http2.mlstatic.com/D_NQ_NP_812350-MLU70103675101_062023-O.webp",
      secondImage:
...

  {
    ...
    imageProduct: {
      firtsImage:
        "https://http2.mlstatic.com/D_NQ_NP_795242-MLA52217913940_102022-O.webp",
      secondImage:
